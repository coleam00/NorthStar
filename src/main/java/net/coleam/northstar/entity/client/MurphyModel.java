...
public class MurphyModel extends GeoModel<MurphyEntity> {
    @Override
    public ResourceLocation getModelResource(MurphyEntity animatable) {
        return new ResourceLocation(NorthStar.MOD_ID, "geo/murphy.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MurphyEntity animatable) {
        return new ResourceLocation(NorthStar.MOD_ID, "textures/entity/murphy.png");
    }

    @Override
    public ResourceLocation getAnimationResource(MurphyEntity animatable) {
        return new ResourceLocation(NorthStar.MOD_ID, "animations/murphy.animation.json");
    }

    @Override
    public void setCustomAnimations(MurphyEntity animatable, long instanceId, AnimationState<MurphyEntity> animationState) {
